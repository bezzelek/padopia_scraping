...
class SpainIdealistaOurenseSpider(scrapy.Spider):
    logger.info('Launching Ourense spider...')
    name = 'IdealistaPropertyOurense'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/ourense-provincia/'
    ]
...
class SpainIdealistaOurenseScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaOurenseSpider
