...
class SpainIdealistaLleidaSpider(scrapy.Spider):
    logger.info('Launching Lleida spider...')
    name = 'IdealistaPropertyLleida'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/lleida-provincia/'
    ]
...
class SpainIdealistaLleidaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaLleidaSpider
