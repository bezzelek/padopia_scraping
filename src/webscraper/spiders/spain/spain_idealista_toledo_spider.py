...
class SpainIdealistaToledoSpider(scrapy.Spider):
    logger.info('Launching Toledo spider...')
    name = 'IdealistaPropertyToledo'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/toledo-provincia/'
    ]
...
class SpainIdealistaToledoScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaToledoSpider
