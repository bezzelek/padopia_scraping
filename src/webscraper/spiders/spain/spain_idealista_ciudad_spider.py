...
class SpainIdealistaCiudadSpider(scrapy.Spider):
    logger.info('Launching Ciudad spider...')
    name = 'IdealistaPropertyCiudad'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/ciudad-real-provincia/'
    ]
...
class SpainIdealistaCiudadScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCiudadSpider
