...
class SpainIdealistaGeronaSpider(scrapy.Spider):
    logger.info('Launching Gerona spider...')
    name = 'IdealistaPropertyGerona'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/girona-provincia/'
    ]
...
class SpainIdealistaGeronaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaGeronaSpider
