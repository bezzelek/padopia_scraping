...
class SpainIdealistaAlbaceteSpider(scrapy.Spider):
    logger.info('Launching Albacete spider...')
    name = 'IdealistaPropertyAlbacete'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/albacete-provincia/'
    ]
...
class SpainIdealistaAlbaceteScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAlbaceteSpider
