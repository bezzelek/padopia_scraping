...
class SpainIdealistaAlmeriaSpider(scrapy.Spider):
    logger.info('Launching Almeria spider...')
    name = 'IdealistaPropertyAlmeria'
    start_urls = [
...
class SpainIdealistaAlmeriaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAlmeriaSpider
