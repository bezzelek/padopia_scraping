...
class SpainIdealistaTenerifeSpider(scrapy.Spider):
    logger.info('Launching Tenerife spider...')
    name = 'IdealistaPropertyTenerife'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/santa-cruz-de-tenerife-provincia/'
    ]
...
class SpainIdealistaTenerifeScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaTenerifeSpider
