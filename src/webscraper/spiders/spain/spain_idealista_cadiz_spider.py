...
class SpainIdealistaCadizSpider(scrapy.Spider):
    logger.info('Launching Cadiz spider...')
    name = 'IdealistaPropertyCadiz'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/cadiz-provincia/'
    ]
...
class SpainIdealistaCadizScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCadizSpider
