...
class SpainIdealistaCaceresSpider(scrapy.Spider):
    logger.info('Launching Caceres spider...')
    name = 'IdealistaPropertyCaceres'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/caceres-provincia/'
    ]
...
class SpainIdealistaCaceresScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCaceresSpider
