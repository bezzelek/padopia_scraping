...
class SpainIdealistaHuescaSpider(scrapy.Spider):
    logger.info('Launching Huesca spider...')
    name = 'IdealistaPropertyHuesca'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/huesca-provincia/'
    ]
...
class SpainIdealistaHuescaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaHuescaSpider
