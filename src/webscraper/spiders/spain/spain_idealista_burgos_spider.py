...
class SpainIdealistaBurgosSpider(scrapy.Spider):
    logger.info('Launching Burgos spider...')
    name = 'IdealistaPropertyBurgos'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/burgos-provincia/'
    ]
...
class SpainIdealistaBurgosScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaBurgosSpider
