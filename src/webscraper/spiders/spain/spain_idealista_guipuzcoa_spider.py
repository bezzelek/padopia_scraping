...
class SpainIdealistaGipuzkoaSpider(scrapy.Spider):
    logger.info('Launching Gipuzkoa spider...')
    name = 'IdealistaPropertyGipuzkoa'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/guipuzcoa/'
    ]
...
class SpainIdealistaGipuzkoaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaGipuzkoaSpider
