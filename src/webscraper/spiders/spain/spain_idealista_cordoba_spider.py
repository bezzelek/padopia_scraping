...
class SpainIdealistaCordobaSpider(scrapy.Spider):
    logger.info('Launching Cordoba spider...')
    name = 'IdealistaPropertyCordoba'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/cordoba-provincia/'
    ]
...
class SpainIdealistaCordobaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCordobaSpider
