...
class SpainIdealistaMurciaSpider(scrapy.Spider):
    logger.info('Launching Murcia spider...')
    name = 'IdealistaPropertyMurcia'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/murcia-provincia/'
    ]
...
class SpainIdealistaMurciaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaMurciaSpider
