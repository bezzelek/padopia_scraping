...
class SpainIdealistaGuadalajaraSpider(scrapy.Spider):
    logger.info('Launching Guadalajara spider...')
    name = 'IdealistaPropertyGuadalajara'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/guadalajara-provincia/'
    ]
...
class SpainIdealistaGuadalajaraScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaGuadalajaraSpider
