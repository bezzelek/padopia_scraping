...
class SpainIdealistaSalamancaSpider(scrapy.Spider):
    logger.info('Launching Salamanca spider...')
    name = 'IdealistaPropertySalamanca'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/salamanca-provincia/'
    ]
...
class SpainIdealistaSalamancaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaSalamancaSpider
