...
class SpainIdealistaRiojaSpider(scrapy.Spider):
    logger.info('Launching Rioja spider...')
    name = 'IdealistaPropertyRioja'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/la-rioja/'
    ]
...
class SpainIdealistaRiojaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaRiojaSpider
