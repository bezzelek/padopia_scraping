...
class SpainIdealistaBiscaySpider(scrapy.Spider):
    logger.info('Launching Biscay spider...')
    name = 'IdealistaPropertyBiscay'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/vizcaya/'
    ]
...
class SpainIdealistaBiscayScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaBiscaySpider
