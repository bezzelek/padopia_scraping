...
class SpainIdealistaTeruelSpider(scrapy.Spider):
    logger.info('Launching Teruel spider...')
    name = 'IdealistaPropertyTeruel'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/teruel-provincia/'
    ]
...
class SpainIdealistaTeruelScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaTeruelSpider
