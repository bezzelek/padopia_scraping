...
class SpainIdealistaCerdanyaSpider(scrapy.Spider):
    logger.info('Launching Cerdanya spider...')
    name = 'IdealistaPropertyCerdanya'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/cerdanya-francesa/'
    ]
...
class SpainIdealistaCerdanyaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCerdanyaSpider
