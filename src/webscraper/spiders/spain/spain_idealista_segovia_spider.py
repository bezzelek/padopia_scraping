...
class SpainIdealistaSegoviaSpider(scrapy.Spider):
    logger.info('Launching Segovia spider...')
    name = 'IdealistaPropertySegovia'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/segovia-provincia/'
    ]
...
class SpainIdealistaSegoviaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaSegoviaSpider
