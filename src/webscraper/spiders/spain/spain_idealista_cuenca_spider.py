...
class SpainIdealistaCuencaSpider(scrapy.Spider):
    logger.info('Launching Cuenca spider...')
    name = 'IdealistaPropertyCuenca'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/cuenca-provincia/'
    ]
...
class SpainIdealistaCuencaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCuencaSpider
