...
class SpainIdealistaHuelvaSpider(scrapy.Spider):
    logger.info('Launching Huelva spider...')
    name = 'IdealistaPropertyHuelva'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/huelva-provincia/'
    ]
...
class SpainIdealistaHuelvaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaHuelvaSpider
