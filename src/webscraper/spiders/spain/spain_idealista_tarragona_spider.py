...
class SpainIdealistaTarragonaSpider(scrapy.Spider):
    logger.info('Launching Tarragona spider...')
    name = 'IdealistaPropertyTarragona'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/tarragona-provincia/'
    ]
...
class SpainIdealistaTarragonaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaTarragonaSpider
