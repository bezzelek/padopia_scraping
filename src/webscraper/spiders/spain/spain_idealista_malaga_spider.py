...
class SpainIdealistaMalagaSpider(scrapy.Spider):
    logger.info('Launching Malaga spider...')
    name = 'IdealistaPropertyMalaga'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/malaga-provincia/'
    ]
...
class SpainIdealistaMalagaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaMalagaSpider
