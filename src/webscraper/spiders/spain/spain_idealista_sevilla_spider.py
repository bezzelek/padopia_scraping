...
class SpainIdealistaSevilleSpider(scrapy.Spider):
    logger.info('Launching Seville spider...')
    name = 'IdealistaPropertySeville'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/sevilla-provincia/'
    ]
...
class SpainIdealistaSevilleScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaSevilleSpider
