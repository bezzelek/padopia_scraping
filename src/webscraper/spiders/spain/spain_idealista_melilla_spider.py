...
class SpainIdealistaMelillaSpider(scrapy.Spider):
    logger.info('Launching Melilla spider...')
    name = 'IdealistaPropertyMelilla'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/melilla-melilla/'
    ]
...
class SpainIdealistaMelillaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaMelillaSpider
