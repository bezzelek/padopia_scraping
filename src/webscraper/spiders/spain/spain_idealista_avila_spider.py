...
class SpainIdealistaAvilaSpider(scrapy.Spider):
    logger.info('Launching Avila spider...')
    name = 'IdealistaPropertyAvila'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/avila-provincia/'
    ]
...
class SpainIdealistaAvilaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAvilaSpider
