...
class SpainIdealistaNavarraSpider(scrapy.Spider):
    logger.info('Launching Navarra spider...')
    name = 'IdealistaPropertyNavarra'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/navarra/'
    ]
...
class SpainIdealistaNavarraScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaNavarraSpider
