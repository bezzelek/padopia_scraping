...
class SpainIdealistaPaisSpider(scrapy.Spider):
    logger.info('Launching Pais spider...')
    name = 'IdealistaPropertyPais'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/pais-vasco-frances/'
    ]
...
class SpainIdealistaPaisScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaPaisSpider
