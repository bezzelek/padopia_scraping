...
class SpainIdealistaMadridSpider(scrapy.Spider):
    logger.info('Launching Madrid spider...')
    name = 'IdealistaPropertyMadrid'
    start_urls = [
...
class SpainIdealistaMadridScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaMadridSpider
