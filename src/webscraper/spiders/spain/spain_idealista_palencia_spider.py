...
class SpainIdealistaPalenciaSpider(scrapy.Spider):
    logger.info('Launching Palencia spider...')
    name = 'IdealistaPropertyPalencia'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/palencia-provincia/'
    ]
...
class SpainIdealistaPalenciaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaPalenciaSpider
