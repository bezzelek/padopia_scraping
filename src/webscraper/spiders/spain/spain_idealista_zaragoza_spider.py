...
class SpainIdealistaZaragozaSpider(scrapy.Spider):
    logger.info('Launching Zaragoza spider...')
    name = 'IdealistaPropertyZaragoza'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/zaragoza-provincia/'
    ]
...
class SpainIdealistaZaragozaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaZaragozaSpider
