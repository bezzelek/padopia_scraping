...
class SpainIdealistaGranadaSpider(scrapy.Spider):
    logger.info('Launching Granada spider...')
    name = 'IdealistaPropertyGranada'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/granada-provincia/'
    ]
...
class SpainIdealistaGranadaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaGranadaSpider
