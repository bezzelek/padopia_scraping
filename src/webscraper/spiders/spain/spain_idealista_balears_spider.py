...
class SpainIdealistaBalearicSpider(scrapy.Spider):
    logger.info('Launching Balearic spider...')
    name = 'IdealistaPropertyBalearic'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/balears-illes/'
    ]
...
class SpainIdealistaBalearicScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaBalearicSpider
