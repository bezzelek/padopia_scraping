...
class SpainIdealistaCastellonSpider(scrapy.Spider):
    logger.info('Launching Castellon spider...')
    name = 'IdealistaPropertyCastellon'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/castellon/'
    ]
...
class SpainIdealistaCastellonScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCastellonSpider
