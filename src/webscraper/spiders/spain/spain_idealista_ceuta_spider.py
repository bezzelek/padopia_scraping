...
class SpainIdealistaCeutaSpider(scrapy.Spider):
    logger.info('Launching Ceuta spider...')
    name = 'IdealistaPropertyCeuta'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/ceuta-ceuta/'
    ]
...
class SpainIdealistaCeutaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCeutaSpider
