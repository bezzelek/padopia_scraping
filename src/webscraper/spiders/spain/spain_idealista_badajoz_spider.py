...
class SpainIdealistaBadajozSpider(scrapy.Spider):
    logger.info('Launching Badajoz spider...')
    name = 'IdealistaPropertyBadajoz'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/badajoz-provincia/'
    ]
...
class SpainIdealistaBadajozScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaBadajozSpider
