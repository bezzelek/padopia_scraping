...
class SpainIdealistaValenciaSpider(scrapy.Spider):
    logger.info('Launching Valencia spider...')
    name = 'IdealistaPropertyValencia'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/valencia-provincia/'
    ]
...
class SpainIdealistaValenciaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaValenciaSpider
