...
class SpainIdealistaAndorraSpider(scrapy.Spider):
    logger.info('Launching Andorra spider...')
    name = 'IdealistaPropertyAndorra'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/andorra-provincia/'
    ]
...
class SpainIdealistaAndorraScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAndorraSpider
