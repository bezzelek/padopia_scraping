...
class SpainIdealistaBarcelonaSpider(scrapy.Spider):
    logger.info('Launching Barcelona spider...')
    name = 'IdealistaPropertyBarcelona'
    start_urls = [
...
class SpainIdealistaBarcelonaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaBarcelonaSpider
