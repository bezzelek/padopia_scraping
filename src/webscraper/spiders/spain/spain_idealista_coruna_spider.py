...
class SpainIdealistaCorunaSpider(scrapy.Spider):
    logger.info('Launching Coruna spider...')
    name = 'IdealistaPropertyCoruna'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/a-coruna-provincia/'
    ]
...
class SpainIdealistaCorunaScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaCorunaSpider
