...
class SpainIdealistaPontevedraSpider(scrapy.Spider):
    logger.info('Launching Pontevedra spider...')
    name = 'IdealistaPropertyPontevedra'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/pontevedra-provincia/'
    ]
...
class SpainIdealistaPontevedraScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaPontevedraSpider
