...
class SpainIdealistaAsturiasSpider(scrapy.Spider):
    logger.info('Launching Asturias spider...')
    name = 'IdealistaPropertyAsturias'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/asturias/'
    ]
...
class SpainIdealistaAsturiasScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAsturiasSpider
