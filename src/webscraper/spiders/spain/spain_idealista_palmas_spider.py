...
class SpainIdealistaPalmasSpider(scrapy.Spider):
    logger.info('Launching Palmas spider...')
    name = 'IdealistaPropertyPalmas'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/las-palmas/'
    ]
...
class SpainIdealistaPalmasScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaPalmasSpider
