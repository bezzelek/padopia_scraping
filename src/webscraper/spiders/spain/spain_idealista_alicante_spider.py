...
class SpainIdealistaAlicanteSpider(scrapy.Spider):
    logger.info('Launching Alicante spider...')
    name = 'IdealistaPropertyAlicante'
    start_urls = [
...
class SpainIdealistaAlicanteScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaAlicanteSpider
