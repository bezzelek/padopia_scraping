...
class SpainIdealistaValladolidSpider(scrapy.Spider):
    logger.info('Launching Valladolid spider...')
    name = 'IdealistaPropertyValladolid'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/valladolid-provincia/'
    ]
...
class SpainIdealistaValladolidScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaValladolidSpider
