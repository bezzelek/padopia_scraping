...
class SpainIdealistaLugoSpider(scrapy.Spider):
    logger.info('Launching Lugo spider...')
    name = 'IdealistaPropertyLugo'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/lugo-provincia/'
    ]
...
class SpainIdealistaLugoScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaLugoSpider
