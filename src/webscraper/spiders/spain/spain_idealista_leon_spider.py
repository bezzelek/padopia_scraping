...
class SpainIdealistaLeonSpider(scrapy.Spider):
    logger.info('Launching Leon spider...')
    name = 'IdealistaPropertyLeon'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/leon-provincia/'
    ]
...
class SpainIdealistaLeonScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaLeonSpider
