...
class SpainIdealistaZamoraSpider(scrapy.Spider):
    logger.info('Launching Zamora spider...')
    name = 'IdealistaPropertyZamora'
    start_urls = [
        'https://www.idealista.com/en/venta-viviendas/zamora-provincia/'
    ]
...
class SpainIdealistaZamoraScraper:
    def __init__(self):
        settings_file_path = 'webscraper.settings'
        os.environ.setdefault('SCRAPY_SETTINGS_MODULE', settings_file_path)
        self.process = CrawlerProcess(get_project_settings())
        self.spider = SpainIdealistaZamoraSpider
